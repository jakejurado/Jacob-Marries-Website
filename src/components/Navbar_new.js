...
import new_arrowL from '../../public/photos/nav_photos/new_ArrowL.jpg';
import new_arrowLP from '../../public/photos/nav_photos/new_ArrowLP.jpg';
...
function Navbar(){
  ...
  //swaps the arrows on hover
  function arrowSwapHover(e){
    const mouseEvent = e._reactName;
    const dom = e.currentTarget
    switch(e.target.id){
      case 'leftArrow':
        dom.src = mouseEvent === 'onMouseOver' ? new_arrowLP : new_arrowL;
        break;
      case 'rightArrow':
        dom.src = mouseEvent === 'onMouseOver' ? new_arrowLP : new_arrowL;
        break;
  ...
  return(
    <nav>
      <div className="photoNav" id='arrowL' onMouseDown={navBarScrolling} onMouseUp={navBarScrolling} ><img  src={new_arrowL} id='leftArrow' width='17px' height='50px' onMouseOver={arrowSwapHover} onMouseLeave={arrowSwapHover}/></div>
      <div id='cover'>
      ...
      <div className="photoNav" id='arrowR' onMouseDown={navBarScrolling} onMouseUp={navBarScrolling}><img src={new_arrowL} width='17px' height='50px' id='rightArrow' onMouseOver={arrowSwapHover} onMouseLeave={arrowSwapHover}/></div>
